...
class Inspector:
    ...
    from application.modules.filechecks import _is_archived
    from application.modules.homoglyph import _has_latin_homoglyphs
    ...
    def __init__(self, targetFileName: str, targetFilePath):
        ...
        self.targetFileNameOnly = list(targetFileName.split('.')[0])
    ...
    def runChecks(self) -> Dict:# -> Union[List[dict()], None]:
        ...
        checks_catalogue = {
            ...
            "Contains_Homoglyphs": self._has_latin_homoglyphs
        }
